        ...
        if submitted:
            ...
            if len(df) >= 1:
                ...
                with st.container():
                    ...
                    st.markdown(f"### 🧠 Why You Got This Result:")
                    st.write(profile['desc'])
                    
                    st.markdown(f"### 🔥 Your Core Strength:")
                    st.write(profile['strength'])
                    
                    st.markdown(f"### ⚠️ Your Hidden Weakness:")
                    st.write(profile['weakness'])
                    
                    st.markdown(f"### 🎵 Your Vibe:")
                    st.write(profile['vibe'])
